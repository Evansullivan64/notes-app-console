...
class NoteAPITest {
    ...
    inner class AddNotes {
        ...
        fun `adding a Note to a populated list adds to ArrayList`() {
            val newNote = Note("Study Lambdas", 1, "College", false,"Done")
    ...
    inner class UpdateNotes {
        ...
        fun `updating a note that does not exist returns false`(){
            assertFalse(populatedNotes!!.updateNote(6, Note("Updating Note", 2, "Work", false,"Todo")))
            assertFalse(populatedNotes!!.updateNote(-1, Note("Updating Note", 2, "Work", false,"Todo")))
            assertFalse(emptyNotes!!.updateNote(0, Note("Updating Note", 2, "Work", false,"Done")))
        }
        ...
        fun `updating a note that exists returns true and updates`() {
            ...
            assertTrue(populatedNotes!!.updateNote(4, Note("Updating Note", 2, "College", false,"Done")))
